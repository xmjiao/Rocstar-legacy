...
void Rocblas::init(const std::string &name) {
  const COM_Type arg4_types[]      = {COM_METADATA, COM_METADATA, COM_METADATA,
                                      COM_METADATA};
  const COM_Type arg4c_types[]     = {COM_METADATA, COM_METADATA, COM_METADATA,
                                      COM_MPI_COMM, COM_METADATA};
  const COM_Type arg4a_types[]     = {COM_VOID, COM_METADATA, COM_METADATA,
                                      COM_METADATA};
  const COM_Type arg3_types[]      = {COM_METADATA, COM_METADATA, COM_METADATA};
  const COM_Type arg4cso_types[]   = {COM_METADATA, COM_VOID, COM_METADATA,
                                      COM_INT};
  const COM_Type arg4mmvm_types[]  = {COM_METADATA, COM_METADATA, COM_VOID,
                                      COM_METADATA};
  const COM_Type arg4mmvcm_types[] = {COM_METADATA, COM_METADATA, COM_VOID,
                                      COM_MPI_COMM, COM_METADATA};
  ...
  COM_set_function((name + ".limit1").c_str(), (Func_ptr)limit1, "iio",
                   arg3_types);
  ...
  COM_set_function((name + ".maxof_scalar").c_str(), (Func_ptr)maxof_scalar,
                   "iioI", arg4cso_types);
  ...
  COM_set_function((name + ".dot_scalar").c_str(), (Func_ptr)dot_scalar, "iioI",
                   arg4mmvm_types);
  COM_set_function((name + ".dot_MPI").c_str(), (Func_ptr)dot_MPI, "iioII",
                   arg4c_types);
  COM_set_function((name + ".dot_scalar_MPI").c_str(), (Func_ptr)dot_scalar_MPI,
                   "iioII", arg4mmvcm_types);
  COM_set_function((name + ".nrm2").c_str(), (Func_ptr)nrm2, "ioI",
                   &arg4_types[1]);
  COM_set_function((name + ".nrm2_scalar").c_str(), (Func_ptr)nrm2_scalar,
                   "ioI", &arg4mmvm_types[1]);

  COM_set_function((name + ".nrm2_MPI").c_str(), (Func_ptr)nrm2_MPI, "ioII",
                   &arg4c_types[1]);
  COM_set_function((name + ".nrm2_scalar_MPI").c_str(),
                   (Func_ptr)nrm2_scalar_MPI, "ioII", &arg4mmvcm_types[1]);
  ...
  COM_set_function((name + ".copy_scalar").c_str(), (Func_ptr)copy_scalar, "io",
                   arg2s_types);
  COM_set_function((name + ".rand_scalar").c_str(), (Func_ptr)rand_scalar, "io",
                   arg2s_types);
  ...
  COM_set_function((name + ".min_MPI").c_str(), (Func_ptr)min_MPI, "ioI",
                   types);
  COM_set_function((name + ".max_MPI").c_str(), (Func_ptr)max_MPI, "ioI",
                   types);
  COM_set_function((name + ".sum_MPI").c_str(), (Func_ptr)sum_MPI, "ioI",
                   types);

  types[1] = COM_VOID;
  COM_set_function((name + ".min_scalar_MPI").c_str(), (Func_ptr)min_scalar_MPI,
                   "ioI", types);
  COM_set_function((name + ".max_scalar_MPI").c_str(), (Func_ptr)max_scalar_MPI,
                   "ioI", types);
  COM_set_function((name + ".sum_scalar_MPI").c_str(), (Func_ptr)sum_scalar_MPI,
                   "ioI", types);
