...
int main(int argc, char *argv[]) {
  ...
  int func = COM_get_function_handle(op.c_str());
  assert(func);
  int arg1 = COM_get_attribute_handle(a1.c_str());
  assert(arg1);
  int arg2 = COM_get_attribute_handle(a2.c_str());
  assert(arg2);
  int arg3 = COM_get_attribute_handle(a3.c_str());
  assert(arg3);
...
void printNodalData(const char *title) {
  ...
  for (i = 0; i < NPANE; i++) {
    for (j = 0; j < NROW * NCOL; j++) {
      for (k = 0; k < 3; k++) std::cout << testxn[i][j][k] << " ";
      std::cout << "     ";
    }
    std::cout << "\n";
  }
  ...
  for (i = 0; i < NPANE; i++) {
    for (j = 0; j < NROW * NCOL; j++) {
      for (k = 0; k < 3; k++) std::cout << testyn[i][j][k] << " ";
      std::cout << "     ";
    }
    std::cout << "\n";
  }
  ...
  for (i = 0; i < NPANE; i++) {
    for (j = 0; j < NROW * NCOL; j++) {
      for (k = 0; k < 3; k++) std::cout << testzn[i][j][k] << " ";
      std::cout << "     ";
    }
    std::cout << "\n";
  }
  ...
  std::cout << "\n\np =\n";
  for (i = 0; i < NPANE; i++) {
    for (j = 0; j < NROW * NCOL; j++) std::cout << paneTestn[i][j] << " ";
    std::cout << "     ";
  }

  std::cout << "\n\naw =\n";
  for (i = 0; i < 3; i++) std::cout << scalWin[i] << " ";

  std::cout << "\n\nap =\n";
  for (i = 0; i < NPANE; i++) {
    for (j = 0; j < 3; j++) std::cout << scalPane[i][j] << " ";
    std::cout << "     ";
  }
  ...
  std::cout << "\nasp =\n";
  for (i = 0; i < NPANE; i++) std::cout << scalSPane[i] << " ";
...
void printStridedNodalData(const char *title) {
  ...
  for (i = 0; i < NPANE; i++) {
    for (j = 0; j < 3; j++) {
      for (k = 0; k < NROW * NCOL; k++) std::cout << testxns[i][j][k] << " ";
      std::cout << "     ";
    }
    std::cout << "\n";
  }
  ...
  for (i = 0; i < NPANE; i++) {
    for (j = 0; j < 3; j++) {
      for (k = 0; k < NROW * NCOL; k++) std::cout << testyns[i][j][k] << " ";
      std::cout << "     ";
    }
    std::cout << "\n";
  }
  ...
  for (i = 0; i < NPANE; i++) {
    for (j = 0; j < 3; j++) {
      for (k = 0; k < NROW * NCOL; k++) std::cout << testzns[i][j][k] << " ";
      std::cout << "     ";
    }
    std::cout << "\n";
  }
...
void printElementalData(const char *title) {
  ...
  for (i = 0; i < NPANE; i++) {
    for (j = 0; j < (NROW - 1) * (NCOL - 1); j++) {
      for (k = 0; k < 3; k++) std::cout << testxe[i][j][k] << " ";
      std::cout << "     ";
    }
    std::cout << "\n";
  }
  ...
  for (i = 0; i < NPANE; i++) {
    for (j = 0; j < (NROW - 1) * (NCOL - 1); j++) {
      for (k = 0; k < 3; k++) std::cout << testye[i][j][k] << " ";
      std::cout << "     ";
    }
    std::cout << "\n";
  }
  ...
  for (i = 0; i < NPANE; i++) {
    for (j = 0; j < (NROW - 1) * (NCOL - 1); j++) {
      for (k = 0; k < 3; k++) std::cout << testze[i][j][k] << " ";
      std::cout << "     ";
    }
    std::cout << "\n";
  }
