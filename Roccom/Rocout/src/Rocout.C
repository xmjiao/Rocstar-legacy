...
void Rocout::init(const std::string& mname) {
  ...
  COM_set_member_function((mname + ".put_attribute").c_str(),
                          (Member_func_ptr)&Rocout::put_attribute, glb.c_str(),
                          "biiiiIII", types);
  COM_set_member_function((mname + ".add_attribute").c_str(),
                          (Member_func_ptr)&Rocout::add_attribute, glb.c_str(),
                          "biiiiIII", types);
 ...
 */
void Rocout::write_attribute(const char* filename_pre, const Attribute* attr,
                             const char* material, const char* timelevel,
 ...
 * \param pane_id the pane to be written.
 */
void Rocout::put_attribute(const char* filename_pre, const Attribute* attr,
                           const char* material, const char* timelevel,
                           const char* mfile_pre, const MPI_Comm* pComm,
                           const int* pane_id) {
  WriteAttrInfo* pWAI;
 ...
 * \param pane_id the pane to be written.
 */
void Rocout::add_attribute(const char* filename_pre, const Attribute* attr,
                           const char* material, const char* timelevel,
                           const char* mfile_pre, const MPI_Comm* pComm,
                           const int* pane_id) {
  WriteAttrInfo* pWAI;
...
extern "C" void COM_F_FUNC2(rocout_load_module,
                            ROCOUT_LOAD_MODULE)(const char* name,
                                                long int    length) {
  Rocout_load_module(std::string(name, length).c_str());
}
extern "C" void COM_F_FUNC2(rocout_unload_module,
                            ROCOUT_UNLOAD_MODULE)(const char* name,
                                                  long int    length) {
