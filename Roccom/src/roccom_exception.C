...
std::ostream &operator<<(std::ostream &os, const COM_exception &ex) {
  os << "Roccom: " << (ex.ierr < 1000 ? "WARNING " : "ERROR ") << ex.ierr
     << ": ";
  std::string msg;
  switch (ex.ierr) {
    ...
    case COM_ERR_WAS_INITIALIZED:
      msg = "Roccom was already initialized";
      break;
    case COM_ERR_WASNOT_INITIALIZED:
      msg = "Roccom was not initialized";
      break;
    ...
    case COM_ERR_ATTRIBUTE_INITIALIZED:
      msg = "Attribute was already intialized";
      break;
    case COM_ERR_ATTRIBUTE_NOT_ALLOCATED:
      msg = "Attribute was not allocated by Roccom";
      break;
    ...
    case COM_ERR_ATTRIBUTE_ALLOCATED:
      msg = "Attribute has already been allocated by Roccom";
      break;
   ...
   and the number of ghosts cannot be greater than the total number of items.";
    ...
    case COM_ERR_NOT_A_WINDOW_ATTRIBUTE:
      msg = "Not a window attribute";
      break;
    case COM_ERR_NOT_A_POINTER:
      msg = "Trying to nullify an attribute that is not a pointer";
      break;
    case COM_ERR_IMMUTABLE:
      msg = "Immutable attributes cannot be passed to mutable arguments";
      break;
    ...
    case COM_ERR_CHANGE_INHERITED:
      msg = "Trying to change the meta-data of an inherited attribute";
      break;
    case COM_ERR_RESIZE:
      msg = "Trying to resize an inherited or user-allocated attribute";
      break;
    case COM_ERR_INHERIT_MESH_LATE:
      msg = "Mesh must be used/cloned before creating any attribute";
      break;
    ...
    case COM_ERR_APPEND_ARRAY:
      msg =
          "Appending array is supported only for window and pane attributes "
          "without ghosts";
      break;
  ...
  os << msg << "\nRoccom: Error encountered when processing " << ex.msg
     << std::endl
     << "Roccom: ";
  return os;
}
...
std::string append_frame_info(const std::string &s, const char *frame,
  ...
  std::sprintf(buf, "\nRoccom: In %s of file %s at line %d", frame, file, line);
  return s + buf;
}
