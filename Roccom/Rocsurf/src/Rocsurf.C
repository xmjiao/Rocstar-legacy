...
void Rocsurf::compute_normals(const COM::Attribute *mesh, COM::Attribute *nrm,
                              const int *scheme) {
  COM_assertion_msg(validate_object() == 0, "Invalid object");
...
// Evaluate nodal normals
void Rocsurf::compute_mcn(COM::Attribute *mcn, COM::Attribute *lbmcn) {
  COM_assertion_msg(validate_object() == 0, "Invalid object");
...
void Rocsurf::elements_to_nodes(const COM::Attribute *elem_vals,
                                ...
                                const COM::Attribute *mesh, const int *scheme,
...
void Rocsurf::serialize_mesh(const COM::Attribute *inmesh,
...
extern "C" void Rocsurf_load_module(const char *mname) { Rocsurf::load(mname); }
